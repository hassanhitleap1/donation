...
@section('content')
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="choose_heading_wrapper">
                        <h1 class="med_bottompadder20 choose_hed">Covid-19 protection FAQ</h1>
                            ...
                            <div class="panel-group" id="accordionFifteenLeft" role="tablist">
                                <div class="panel panel-default sidebar_pannel">
                                    <div class="panel-heading desktop">
                                        <h4 class="panel-title">
													<a class="collapsed active" data-toggle="collapse" href="#collapseEightLeftone" aria-expanded="false">- Wash your hands frequently</a>
												</h4>
                                    </div>
                                    <div id="collapseEightLeftone" class="panel-collapse collapse show" data-parent="#accordionFifteenLeft" aria-expanded="true" role="tabpanel">
                                        <div class="panel-body">
                                            <div class="panel_cont">
                                                <p>Regularly and thoroughly clean your hands with an alcohol-based hand rub or wash them with soap and water. <strong>Why? Washing your hands with soap and water or using alcohol-based hand rub kills viruses that may be on your hands.</strong></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-default sidebar_pannel">
                                    <div class="panel-heading horn">
                                        <h4 class="panel-title">
													<a class="collapsed" data-toggle="collapse" href="#collapseEightLefttwo" aria-expanded="false">- Maintain social distancing</a>
												</h4>
                                    </div>
                                    <div id="collapseEightLefttwo" class="panel-collapse collapse " data-parent="#accordionFifteenLeft" aria-expanded="false" style="height: 0px;" role="tabpanel">
                                        <div class="panel-body">
                                            <div class="panel_cont">
                                                <p>Maintain at least 1 metre (3 feet) distance between yourself and anyone who is coughing or sneezing.<strong>Why? When someone coughs or sneezes they spray small liquid droplets from their nose or mouth which may contain virus. If you are too close, you can breathe in the droplets, including the COVID-19 virus if the person coughing has the disease</strong></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-default sidebar_pannel">
                                    <div class="panel-heading horn">
                                        <h4 class="panel-title">
													<a class="collapsed" data-toggle="collapse" href="#collapseEightLefttwo1" aria-expanded="false">- Avoid touching eyes, nose and mouth</a>
												</h4>
                                    </div>
                                    <div id="collapseEightLefttwo1" class="panel-collapse collapse " data-parent="#accordionFifteenLeft" aria-expanded="false" style="height: 0px;" role="tabpanel">
                                        <div class="panel-body">
                                            <div class="panel_cont">
                                ...
                                <div class="panel panel-default sidebar_pannel">
                                    <div class="panel-heading bell">
                                        <h4 class="panel-title">
													<a class="collapsed" data-toggle="collapse" href="#collapseEightLeftfour" aria-expanded="false">- Practice respiratory hygiene</a>
												</h4>
                                    </div>
                                    <div id="collapseEightLeftfour" class="panel-collapse collapse" data-parent="#accordionFifteenLeft" aria-expanded="false" style="height: 0px;" role="tabpanel">
                                        <div class="panel-body">
                                            <div class="panel_cont">
                                                <p>Make sure you, and the people around you, follow good respiratory hygiene. This means covering your mouth and nose with your bent elbow or tissue when you cough or sneeze. Then dispose of the used tissue immediately. <strong>Why? Droplets spread virus. By following good respiratory hygiene you protect the people around you from viruses such as cold, flu and COVID-19.</strong></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-default sidebar_pannel">
                                    <div class="panel-heading bell">
                                        <h4 class="panel-title">
									<a class="collapsed" data-toggle="collapse" href="#collapseEightLeftsix"        aria-expanded="false">- Stay home if you feel unwell.</a>
												</h4>
                                    </div>
                                    <div id="collapseEightLeftsix" class="panel-collapse collapse" data-parent="#accordionFifteenLeft" aria-expanded="false" style="height: 0px;" role="tabpanel">
                                        <div class="panel-body">
                                            <div class="panel_cont">
                                                <p>Between people who are in close contact with one another (within about 6 feet).</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="owl_box">
                        <div class="med_slider_img">
                            <div class="owl-carousel owl-theme">
                                <div class="item">
                                    <img src="images/corona/chs_slider_img.jpg" class="img-responsive" alt="story_img" />
                                </div>
                                <div class="item">
                                    <img src="images/corona/chs_slider_img2.jpg" class="img-responsive" alt="story_img" />
                                </div>
                                <div class="item">
                                    <img src="images/corona/chs_slider_img3.jpg" class="img-responsive" alt="story_img" />
                                </div>
                                <div class="item">
                                    <img src="images/corona/chs_slider_img4.jpg" class="img-responsive" alt="story_img" />
                                </div>
                                <div class="item">
                                    <img src="images/corona/chs_slider_img5.jpg" class="img-responsive" alt="story_img" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 col-lg-offset-2">
                    <div class="team_heading_wrapper med_bottompadder40 wow fadeIn" data-wow-delay="0.3s">
                        <h1 class="med_bottompadder20">MEET OUR Covid-19 SPECIALISTS</h1>
                        <img src="images/Icon_team.png" alt="line" class="med_bottompadder20">
                        <p>Coronavirus symptoms: what are they and should I call a doctor? we have the best coronavirus Doctor team.</p>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="team_about">
                                            ...
                                            <div class="team_img">
                                                <a href="doctor.html"><img src="images/corona/team_1.jpg" alt="img" class="img-responsive"></a>
                                            </div>
                                            <div class="team_txt">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 d-none d-sm-none d-md-none d-lg-block">
                                        <div class="team_about">
                                            ...
                                            <div class="team_img">
                                                <a href="doctor.html"><img src="images/corona/team_2.jpg" alt="img" class="img-responsive"></a>
                                            </div>
                                            <div class="team_txt">
                                                <h1><a href="#">Dr. Robert </a></h1>
                                                <p>(virus expert)</p>
                                            </div>
                                            <div class="team_icon_hover our_doc_icn_hovr">
                                                <ul>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 d-none d-sm-none d-md-block">
                                        <div class="team_about">
                                            ...
                                            <div class="team_img">
                                                <a href="doctor.html"><img src="images/corona/team_3.jpg" alt="img" class="img-responsive"></a>
                                            </div>
                                            <div class="team_txt">
                                                <h1><a href="#">Dr. Mary</a></h1>
                                                <p>(virus expert)</p>
                                            </div>
                                            <div class="team_icon_hover our_doc_icn_hovr">
                                                <ul>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 d-none d-sm-none d-md-none d-lg-block">
                                        <div class="team_about">
                                            ...
                                            <div class="team_img">
                                                <a href="doctor.html"><img src="images/corona/team_4.jpg" alt="img" class="img-responsive"></a>
                                            </div>
                                            <div class="team_txt">
                                                <h1><a href="#">Dr. James</a></h1>
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 d-none d-sm-none d-md-block">
                                        <div class="team_about">
                                            ...
                                            <div class="team_img">
                                                <a href="doctor.html"><img src="images/corona/team_5.jpg" alt="img" class="img-responsive"></a>
                                            </div>
                                            <div class="team_txt">
                                                <h1><a href="#">Dr. Johan Doe</a></h1>
                                                <p>(virus expert)</p>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 d-none d-sm-none d-md-none d-lg-block">
                                        <div class="team_about">
                                            ...
                                            <div class="team_img">
                                                <a href="doctor.html"><img src="images/corona/team_6.jpg" alt="img" class="img-responsive"></a>
                                            </div>
                                            <div class="team_txt">
                                                <h1><a href="#">Dr. Johan Doe</a></h1>
                                                <p>(virus expert)</p>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="team_about">
                                            ...
                                            <div class="team_img">
                                                <a href="doctor.html"><img src="images/corona/team_7.jpg" alt="img" class="img-responsive"></a>
                                            </div>
                                            <div class="team_txt">
                                                <h1><a href="#">Dr. Johan Doe</a></h1>
                                                <p>(virus expert)</p>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 d-none d-sm-none d-md-none d-lg-block">
                                        <div class="team_about">
                                            ...
                                            <div class="team_img">
                                                <a href="doctor.html"><img src="images/corona/team_8.jpg" alt="img" class="img-responsive"></a>
                                            </div>
                                            <div class="team_txt">
                                                <h1><a href="#">Dr. Johan Doe</a></h1>
                                                <p>(virus expert)</p>
    ...
    <!--vedio wrapper end-->
    <!-- blog wrapper start-->
    <div class="blog_wrapper med_toppadder100 med_bottompadder100">
        <div class="container">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 col-lg-offset-2">
                    <div class="team_heading_wrapper med_bottompadder50 wow fadeIn" data-wow-delay="0.3s">
                        <h1 class="med_bottompadder20">News About Codid-19</h1>
                        <img src="images/Icon_team.png" alt="line" class="med_bottompadder20">
                        <p>Coronavirus Updates in all over the world. Stay tune</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="blog_about">
                        <div class="blog_img">
                            <figure>
                                <img src="images/corona/blog_img_1.jpg" alt="img" class="img-responsive">
                            </figure>
                        </div>
                        ...
                        <div class="blog_txt">
                            <h1><a href="blog_single.html">Covid-19 Cases & Latest Updates</a></h1>
                            ...
                            <p>PM Modi conveyed his good wishes for early recovery of all those suffering from the disease in Russia and expressed the hope that Russia’s efforts, led by President Putin, to fight the disease would be successful.</p>
                            <a href="blog_single.html">Read More <i class="fa fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="blog_about">
                        <div class="blog_img">
                            <figure>
                                <img src="images/corona/blog_img_2.jpg" alt="img" class="img-responsive">
                            </figure>
                        </div>
                        <div class="blog_comment">
                            <ul>
                        ...
                        <div class="blog_txt">
                            <h1><a href="blog_single.html">Codid-19 Out Break</a></h1>
                            <div class="blog_txt_info">
                                <ul>
                                    <li>BY ADMIN</li>
                                    <li>March.29,2020</li>
                            ...
                            <p>"In view of COVID19, it has been ordered to temporarily suspend the collection of toll at all toll plaza across India. This will not only reduce inconvenience to the supply of emergency services but also save critical time,</p>
                            <a href="blog_single.html">Read More <i class="fa fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="blog_about">
                        <div class="blog_img">
                            <figure>
                                <img src="images/corona/blog_img_3.jpg" alt="img" class="img-responsive">
                            </figure>
                        </div>
                        <div class="blog_comment">
                            <ul>
                        ...
                        <div class="blog_txt">
                            <h1><a href="blog_single.html">Global death crosses 15,000</a></h1>
                            <div class="blog_txt_info">
                                <ul>
                                    <li>BY ADMIN</li>
                                    <li>March.29,2020</li>
                            ...
                            <p>Confirmed infections of the rapidly spreading coronavirus surpassed 350,000 worldwide on Monday and global deaths rose past 15,000, as COVID-19 spreads across Europe and North America.</p>
                            <a href="blog_single.html">Read More <i class="fa fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <div id="gridWrapper" class="fliter_main_wrapper_2">
        <div class="container">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 col-lg-offset-2">
                    <div class="team_heading_wrapper text-center med_bottompadder40 med_topmargin100 wow fadeIn" data-wow-delay="0.3s">
                        <h1 class="med_bottompadder20">Covid-19 Image Gallery</h1>
                        <img src="images/Icon_team.png" alt="line" class="med_bottompadder20">
                        <p>Covid 19 Latest Breaking News, Pictures, Videos, and Special Reports from The Economic Times. Covid 19 Blogs, Comments and Archive News</p>
                    </div>
                </div>
                <div class="portfolio-area">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <ul class="protfoli_filter gallerY_wrapper">
                                    ...
                                    <li data-filter=".business" class=""><a href="#">Safety</a></li>
                                    <li data-filter=".website" class=""><a href="#">Symptoms</a></li>
                                    <li data-filter=".photoshop" class=""><a href="#">Prevention</a></li>
                                </ul>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="row portfoli_inner">
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 portfolio-wrapper all photoshop">
                                        <div class="portfolio-thumb">
                                            <div class="port_img_wrapper">
                                                <img src="images/corona/dc_galry_img_1.jpg" alt="filter_img">
                                            </div>
                                            <div class="portfolio_icon_wrapper_3 zoom_popup">
                                                <a class="img-link" href="images/corona/dc_galry_img_1.jpg"> <i class="fa fa-search-plus"></i>
                                                </a>
                                            </div>
                                            ...
                                            <div class="portfolio-content">
                                                <div class="portfolio-info_3">
                                                    ...
                                                    <p class="d-none d-sm-none d-md-none d-lg-block">Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh elit. </p>
                                                </div>
                                                <!-- portfolio-info -->
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 portfolio-wrapper all business website photoshop">
                                        <div class="portfolio-thumb">
                                            <div class="port_img_wrapper">
                                                <img src="images/corona/dc_galry_img_2.jpg" alt="filter_img">
                                            </div>
                                            <div class="portfolio_icon_wrapper_3 zoom_popup">
                                                <a class="img-link" href="images/corona/dc_galry_img_2.jpg"> <i class="fa fa-search-plus"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 portfolio-wrapper all website business">
                                        <div class="portfolio-thumb">
                                            <div class="port_img_wrapper">
                                                <img src="images/corona/dc_galry_img_1.jpg" alt="filter_img">
                                            </div>
                                            <div class="portfolio_icon_wrapper_3 zoom_popup">
                                                <a class="img-link" href="images/corona/dc_galry_img_3.jpg"> <i class="fa fa-search-plus"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 portfolio-wrapper all business website photoshop">
                                        <div class="portfolio-thumb">
                                            <div class="port_img_wrapper">
                                                <img src="images/corona/dc_galry_img_4.jpg" alt="filter_img">
                                            </div>
                                            <div class="portfolio_icon_wrapper_3 zoom_popup">
                                                <a class="img-link" href="images/corona/dc_galry_img_4.jpg"> <i class="fa fa-search-plus"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12  portfolio-wrapper all website business">
                                        <div class="portfolio-thumb">
                                            <div class="port_img_wrapper">
                                                <img src="images/corona/dc_galry_img_5.jpg" alt="filter_img">
                                            </div>
                                            <div class="portfolio_icon_wrapper_3 zoom_popup">
                                                <a class="img-link" href="images/corona/dc_galry_img_5.jpg"> <i class="fa fa-search-plus"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12  portfolio-wrapper all business website">
                                        <div class="portfolio-thumb">
                                            <div class="port_img_wrapper">
                                                <img src="images/corona/dc_galry_img_6.jpg" alt="filter_img">
                                            </div>
                                            <div class="portfolio_icon_wrapper_3 zoom_popup">
                                                <a class="img-link" href="images/corona/dc_galry_img_6.jpg"> <i class="fa fa-search-plus"></i>
                                                </a>
                                            </div>
                        ...
                        <div class="text-center portfolio-btn gallerY_btn med_bottommargin100">
                            <a href="gallery_3.html" class="btn">Load More</a>
                        </div>
                    </div>
                    <!-- /.container -->
                </div>
                    ...
                    <div class="test_slider_wrapper">
                        <div class="owl-carousel owl-theme">
                            <div class="item">
                                <div class="t_icon_wrapper">
                                    <div class="t_client_cont_wrapper2">
                                        <p>“It’s always better to avoid persons or acquaintances with travel history. That’s a good way to avoid Covid-19 positive patients with no symptoms. That’s the reason why social distancing measures are being encouraged,” says Superintendent, Fever Hospital, Dr. K Shankar. ”</p>
                                        <div class="client_img_abt">
                                            <img class="img-circle" src="images/corona/test_img_1.png" alt="img">
                                            <h5>- Ciwi</h5>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="t_icon_wrapper">
                                    <div class="t_client_cont_wrapper2">
                                        <p>“ On many occasions, Covid-19 positive asymptomatic persons escape testing because there are no symptoms. Public health officials worldwide have argued that it’s vital to test all foreign-returned persons just to be 100 per cent sure. ”</p>
                                        <div class="client_img_abt">
                                            <img class="img-circle" src="images/corona/test_img_2.png" alt="img">
                                            <h5>- Jhon</h5>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="t_icon_wrapper">
                                    <div class="t_client_cont_wrapper2">
                                        <p>“ One of the challenges that the novel strain of coronavirus has posed to the health authorities is its ability to remain hidden among asymptomatic persons. There are cases wherein a person is Covid-19 positive but will not have any typical symptoms like fever, cold and cough. ”</p>
                                        <div class="client_img_abt">
                                            <img class="img-circle" src="images/corona/test_img_3.png" alt="img">
                                            <h5>- Charry</h5>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="booking_wrapper med_toppadder100 med_bottompadder90">
        <div class="container">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 col-lg-offset-2">
                    <div class="team_heading_wrapper med_bottompadder50 wow fadeIn" data-wow-delay="0.3s">
                        <h1 class="med_bottompadder20">BOOK APPOINTMENT for Covid-19</h1>
                        <img src="images/Icon_team.png" alt="line" class="med_bottompadder20">
                        <p>BOOK APPOINTMENT about COVID-19, Please Fill the Form</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="booking_chat">
                                ...
                                <p> If you have mild Corona symptoms, call your doctor. To reduce transmission of the virus, call. </p>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12">
                    <div class="newsletter_text wow fadeIn" data-wow-delay="0.3s">
                        <h3>Consult your local medical authority for Corona advice:</h3>
                    </div>
                </div>
